...
namespace tool_coursebulkactions\filters;
...
class course_filter_customfield {
    ...
    public function setupForm(&$mform) { // phpcs:ignore
        ...
        $objs['field']->setLabel(get_string('coursefilterfield', 'tool_coursebulkactions'));
        $objs['op']->setLabel(get_string('coursefilterlimiter', 'tool_coursebulkactions'));
    ...
    public function get_label($data) {
        ...
        switch ($operator) {
            ...
            case 3: // Starts with.
            case 4: // Ends with.
                return get_string('courselabel', 'tool_coursebulkactions', $a);
            case 5: // Empty.
            case 6: // Is not defined.
            case 7: // Is defined.
                return get_string('courselabelnovalue', 'tool_coursebulkactions', $a);
        }
        return '';
    }
}
